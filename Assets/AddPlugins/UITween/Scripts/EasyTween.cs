...
public class EasyTween : MonoBehaviour
{
    ...
    {
        RectTransform selectedTransform = this.rectTransform;

        if (this.animationParts.PositionPropetiesAnim.IsPositionEnabled())
            selectedTransform.anchoredPosition = (Vector2)this.animationParts.PositionPropetiesAnim.StartPos;

        if (this.animationParts.ScalePropetiesAnim.IsScaleEnabled())
            selectedTransform.localScale = this.animationParts.ScalePropetiesAnim.StartScale;
